...
[![tests](https://img.shields.io/badge/tests-658%20passing-22863a)](#tests)
...
pytest                         # 605 tests — research, syncing, the API, the live call, the tools
```

658 tests in total. None of them load a language model: a test that spends six seconds on
